...
#SetAcl (Get-ADUser "VulnUser") (Get-ADGroup "VulnGroup") "GenericAll" "None"
...
#SetAcl (Get-ADUser "Attacker") (Get-ADGroup "Admins. del dominio") "GenericAll" "None"
...
#SetAclExtended (Get-ADUser "gary") (Get-ADGroup "Safari") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
