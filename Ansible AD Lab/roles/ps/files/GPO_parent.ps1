...
New-GPLink -Target "DC=secure,DC=domain" -Name Registry
...
#Importamos la GPO
Import-GPO -BackupId C3C5EE69-F7BC-4B58-8408-58ED93398961 -TargetName RDP -path "C:\Users\Administrador\Downloads\"
New-GPLink -Target "DC=secure,DC=domain" -Name RDP
